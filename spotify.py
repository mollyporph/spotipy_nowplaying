...
class SpotifySong:
    def __init__(self, trackId: str, length: int, artUrl:str, album: str, albumArtists: List[str], artists: List[str], autoRating: float, discNumber: int, title: str, trackNumber: int, url: str, playbackStatus: str):
        self.trackId: str = trackId
        self.length: int = length
        self.artUrl: str = artUrl
        self.album: str = album
        self.albumArtists: List[str] = [str(x) for x in albumArtists if albumArtists]
